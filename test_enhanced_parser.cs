...
";
        ...
        try
        {
            ...
            if (success)
            {
                ...
                // Check if we have the root prim
                var rootPrim = layer.GetPrimAtPath(new SdfPath("/World"));
                if (rootPrim != null)
                {
                    Console.WriteLine("✅ Found root prim: /World");
                    
                    // Check metadata
                    var metadata = rootPrim.GetMetadata();
                    ...
                    // Check properties
                    var properties = rootPrim.GetProperties();
                    ...
                    // Check child prims
                    var children = rootPrim.GetChildren();
                ...
                {
                    Console.WriteLine("❌ Root prim not found");
                }
            }
            else
            {
